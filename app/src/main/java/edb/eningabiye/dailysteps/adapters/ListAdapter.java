...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    Context context;
    public ListAdapter(ArrayList<Step> myDataset, Context context) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View v) {
            ...
            v.setOnClickListener(view ->  {
                ...
                String msg = String.format("Hi! Voilà les pas que j'ai faits le %s",data.get(getLayoutPosition()).getDate());
